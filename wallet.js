...
// MONAD Network and Contract Details
...
export async function setupEthers() {
    ...
    if (!privyProvider) {
        console.error("Privy provider not available");
        return;
    }
...
export async function submitScoreToLeaderboard(score) {
    ...
    try {
        // We submit the score and 1 transaction count
